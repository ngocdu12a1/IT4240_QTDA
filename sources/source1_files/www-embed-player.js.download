...
Fb("<!DOCTYPE html>",0);var Gb=Fb("",0);Fb("<br>",0);function Ib(a,b){var c=b instanceof G?b:yb(b);a.href=wb(c)}
...
function b(p){for(var x=g,u=0;64>u;u+=4)x[u/4]=p[u]<<24|p[u+1]<<16|p[u+2]<<8|p[u+3];for(u=16;80>u;u++)p=x[u-3]^x[u-8]^x[u-14]^x[u-16],x[u]=(p<<1|p>>>31)&4294967295;p=e[0];var E=e[1],T=e[2],oa=e[3],Cc=e[4];for(u=0;80>u;u++){if(40>u)if(20>u){var Ja=oa^E&(T^oa);var Hb=1518500249}else Ja=E^T^oa,Hb=1859775393;else 60>u?(Ja=E&T|oa&(E|T),Hb=2400959708):(Ja=E^T^oa,Hb=3395469782);Ja=((p<<5|p>>>27)&4294967295)+Ja+Cc+Hb+x[u]&4294967295;Cc=oa;oa=T;T=(E<<30|E>>>2)&4294967295;E=p;p=Ja}e[0]=e[0]+p&4294967295;e[1]=
e[1]+E&4294967295;e[2]=e[2]+T&4294967295;e[3]=e[3]+oa&4294967295;e[4]=e[4]+Cc&4294967295}
...
var Ic;
function Jc(){var a=v.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&-1==zb.indexOf("Presto")&&(a=function(){var e=cc(document,"IFRAME");e.style.display="none";e.src=kb(new hb(ib,fb())).toString();document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(Eb(Gb));e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=A(function(k){if(("*"==h||
...
function de(a){return O(a,void 0)}
function ee(){return O("PLAYER_CONFIG",{})}
;function fe(){var a=ge;y("yt.ads.biscotti.getId_")||w("yt.ads.biscotti.getId_",a,void 0)}
function he(a){w("yt.ads.biscotti.lastId_",a,void 0)}
;var ie=[];function je(a){ie.forEach(function(b){return b(a)})}
function ke(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){P(b),je(b)}}:a}
function P(a,b,c,d,e){var f=y("yt.logging.errors.log");f?f(a,b,c,d,e):(f=O("ERRORS",[]),f.push([a,b,c,d,e]),N("ERRORS",f))}
function le(a){P(a,"WARNING",void 0,void 0,void 0)}
;function me(a){var b=[];Sa(a,function(c,d){var e=encodeURIComponent(String(d)),f;z(c)?f=c:f=[c];F(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
function ne(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),g=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?z(b[f])?Qa(b[f],g):b[f]=[b[f],g]:b[f]=g}catch(k){var h=Error("Error decoding URL component");h.params="key: "+e[0]+", value: "+e[1];"q"==e[0]?le(h):P(h)}}return b}
function oe(a,b){return pe(a,b||{},!0)}
function pe(a,b,c){var d=a.split("#",2);a=d[0];d=1<d.length?"#"+d[1]:"";var e=a.split("?",2);a=e[0];e=ne(e[1]||"");for(var f in b)!c&&null!==e&&f in e||(e[f]=b[f]);return lc(a,e)+d}
...
w("yt.ads_.signals_.getAdSignalsString",function(a){return me(qe(a))},void 0);B();function Q(a){a=ue(a);return"string"===typeof a&&"false"===a?!1:!!a}
function ve(a,b){var c=ue(a);return void 0===c&&void 0!==b?b:Number(c||0)}
function ue(a){var b=O("EXPERIMENTS_FORCED_FLAGS",{});return void 0!==b[a]?b[a]:O("EXPERIMENT_FLAGS",{})[a]}
...
;function R(a,b){Aa(a)&&(a=ke(a));return window.setTimeout(a,b)}
...
Be=!1;
function Ce(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=J(1,a),e=I(J(3,a));d&&e?(d=c,c=a.match(ic),d=d.match(ic),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?I(J(3,c))==e&&(Number(J(4,c))||null)==(Number(J(4,a))||null):!0;d=Q("web_ajax_ignore_global_headers_if_set");for(var f in ze)e=O(ze[f]),!e||!c&&!De(a,f)||d&&void 0!==b[f]||(b[f]=e);if(c||De(a,"X-YouTube-Utc-Offset"))b["X-YouTube-Utc-Offset"]=String(-(new Date).getTimezoneOffset());(c||De(a,"X-YouTube-Time-Zone"))&&(f="undefined"!=typeof Intl?
(new Intl.DateTimeFormat).resolvedOptions().timeZone:null)&&(b["X-YouTube-Time-Zone"]=f);(Q("pass_biscotti_id_in_header_ajax")||Q("pass_biscotti_id_in_header_ajax_tv"))&&(c||De(a,"X-YouTube-Ad-Signals"))&&(b["X-YouTube-Ad-Signals"]=me(qe(void 0)));return b}
function Ee(a){var b=window.location.search,c=I(J(3,a)),d=I(J(5,a));d=(c=c&&(c.endsWith("youtube.com")||c.endsWith("youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=ne(b),f={};F(Ae,function(g){e[g]&&(f[g]=e[g])});
return pe(a,f||{},!1)}
function De(a,b){var c=O("CORS_HEADER_WHITELIST")||{},d=I(J(3,a));return d?(c=c[d])?0<=Ia(c,b):!1:!0}
...
b.na&&0<b.timeout&&(f=R(function(){e||(e=!0,S(f),b.na.call(b.context||v))},b.timeout))}else Ie(a,b)}
function Ie(a,b){var c=b.format||"JSON";a=Ge(a,b);var d=He(a,b),e=!1,f,g=Je(a,function(h){if(!e){e=!0;f&&S(f);var k=ye(h),l=null,n=400<=h.status&&500>h.status,p=500<=h.status&&600>h.status;if(k||n||p)l=Ke(c,h,b.nb);if(k)a:if(h&&204==h.status)k=!0;else{switch(c){case "XML":k=0==parseInt(l&&l.return_code,10);break a;case "RAW":k=!0;break a}k=!!l}l=l||{};n=b.context||v;k?b.onSuccess&&b.onSuccess.call(n,h,l):b.onError&&b.onError.call(n,h,l);b.ia&&b.ia.call(n,h,l)}},b.method,d,b.headers,b.responseType,
b.withCredentials);
b.O&&0<b.timeout&&(f=R(function(){e||(e=!0,g.abort(),S(f),b.O.call(b.context||v,g))},b.timeout));
return g}
function Ge(a,b){b.qb&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=O("XSRF_FIELD_NAME",void 0),d=b.Xa;d&&(d[c]&&delete d[c],a=oe(a,d));return a}
function He(a,b){var c=O("XSRF_FIELD_NAME",void 0),d=O("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.C,g=de("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.pb||I(J(3,a))&&!b.withCredentials&&I(J(3,a))!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.C&&b.C[g]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=ne(e),bb(e,f),e=b.oa&&"JSON"==b.oa?JSON.stringify(e):kc(e));f=e||f&&!Wa(f);!Be&&f&&"POST"!=b.method&&(Be=!0,P(Error("AJAX request with postData should use POST")));
return e}
function Ke(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=JSON.parse(a));break;case "XML":if(b=(b=b.responseXML)?Le(b):null)d={},F(b.getElementsByTagName("*"),function(e){d[e.tagName]=Me(e)})}c&&Ne(d);
return d}
function Ne(a){if(Ba(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Fb(a[b],null);a[c]=d}else Ne(a[b])}}
function Le(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function Me(a){var b="";F(a.childNodes,function(c){b+=c.nodeValue});
return b}
function Je(a,b,c,d,e,f,g){function h(){4==(k&&"readyState"in k?k.readyState:0)&&b&&ke(b)(k)}
...
'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a))):e?Je(a,b,"POST",e,d):O("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?Je(a,b,"GET","",d):Re(a,b)||Se(a,b))}
function Re(a,b){var c=ce.EXPERIMENT_FLAGS;if(!c||!c.web_use_beacon_api_for_ad_click_server_pings)return!1;c=I(J(5,a));return c&&-1!=c.indexOf("/aclk")&&"1"===nc(a,"ae")&&"1"===nc(a,"act")?Te(a)?(b&&b(),!0):!1:!1}
...
c.src=a}
;function Ue(a){a=Error.call(this,a);this.message=a.message;"stack"in a&&(this.stack=a.stack)}
r(Ue,Error);var Ve=new Set,We=0;function Xe(a,b,c,d,e,f){f=f||{};f.name=c||O("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||O("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);b=void 0===b?"ERROR":b;e=void 0===e?!1:e;b=void 0===b?"ERROR":b;e=window&&window.yterr||(void 0===e?!1:e)||!1;if(!(!a||!e||5<=We||(Q("console_log_js_exceptions")&&(e=a,c=[],c.push("Name: "+e.name),c.push("Message: "+e.message),e.hasOwnProperty("params")&&c.push("Error Params: "+JSON.stringify(e.params)),c.push("File name: "+e.fileName),c.push("Stacktrace: "+e.stack),
window.console.log(c.join("\n"),e)),e=a.stacktrace,c=a.columnNumber,a.hasOwnProperty("params")&&(d=String(JSON.stringify(a.params)),f.params=d.substr(0,500)),a=Sb(a),e=e||a.stack,d=a.lineNumber.toString(),isNaN(d)||isNaN(c)||(d=d+":"+c),window.yterr&&Aa(window.yterr)&&window.yterr(a),Ve.has(a.message)||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")))){b={Xa:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:d,level:b,"client.name":f.name},C:{url:O("PAGE_NAME",window.location.href),
file:a.fileName},method:"POST"};f.version&&(b["client.version"]=f.version);e&&(b.C.stack=e);for(var g in f)b.C["client."+g]=f[g];if(g=O("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var h in g)b.C[h]=g[h];Ie(O("ECATCHER_REPORT_HOST","")+"/error_204",b);Ve.add(a.message);We++}}
;var Ye=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};w("yt.msgs_",Ye,void 0);function Ze(a){be(Ye,arguments)}
...
;var df=y("ytPubsubPubsubInstance")||new M;M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.N;M.prototype.publish=M.prototype.M;M.prototype.clear=M.prototype.clear;w("ytPubsubPubsubInstance",df,void 0);var ef=y("ytPubsubPubsubSubscribedKeys")||{};w("ytPubsubPubsubSubscribedKeys",ef,void 0);var ff=y("ytPubsubPubsubTopicToKeys")||{};w("ytPubsubPubsubTopicToKeys",ff,void 0);var gf=y("ytPubsubPubsubIsSynchronous")||{};w("ytPubsubPubsubIsSynchronous",gf,void 0);
function hf(a,b){var c=jf();if(c){var d=c.subscribe(a,function(){var e=arguments;var f=function(){ef[d]&&b.apply(window,e)};
try{gf[a]?f():R(f,0)}catch(g){P(g)}},void 0);
ef[d]=!0;ff[a]||(ff[a]=[]);ff[a].push(d);return d}return 0}
function kf(a){var b=jf();b&&("number"===typeof a?a=[a]:"string"===typeof a&&(a=[parseInt(a,10)]),F(a,function(c){b.unsubscribeByKey(c);delete ef[c]}))}
...
function nf(a){ff[a]&&(a=ff[a],F(a,function(b){ef[b]&&delete ef[b]}),a.length=0)}
...
function rf(a,b,c){c=void 0===c?null:c;var d=sf(a),e=document.getElementById(d),f=e&&bf(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=hf(d,b),b=""+(b[Ca]||(b[Ca]=++Da)),tf[b]=f),g||(e=uf(a,d,function(){bf(e,"loaded")||($e(e),lf(d),R(Ga(mf,d),0))},c)))}
function uf(a,b,c,d){d=void 0===d?null:d;var e=cc(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function wf(a,b){if(a&&b){var c=""+(b[Ca]||(b[Ca]=++Da));(c=tf[c])&&kf(c)}}
function sf(a){var b=document.createElement("a");Ib(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Lb(a)}
var tf={};function xf(){}
function yf(a,b){return zf(a,1,b)}
;function Af(){}
r(Af,xf);function zf(a,b,c){isNaN(c)&&(c=void 0);var d=y("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):R(a,c||0)}
...
xa(Af);Af.getInstance();var Bf=[],Cf=!1;function Df(){if("1"!=Ta(ee(),"args","privembed")){var a=function(){Cf=!0;"google_ad_status"in window?N("DCLKSTAT",1):N("DCLKSTAT",2)};
qf("//static.doubleclick.net/instream/ad_status.js",a);Bf.push(yf(function(){Cf||"google_ad_status"in window||(wf("//static.doubleclick.net/instream/ad_status.js",a),Cf=!0,N("DCLKSTAT",3))},5E3))}}
function Ef(){return parseInt(O("DCLKSTAT",0),10)}
;function Ff(){this.g=!1;this.f=null}
Ff.prototype.initialize=function(a,b,c,d,e){var f=this;b?(this.g=!0,qf(b,function(){f.g=!1;if(window.botguard)Gf(f,c,d);else{vf(b);var g=Error("Unable to load Botguard");g.params="from "+b;le(g)}},e)):a&&(eval(a),window.botguard?Gf(this,c,d):le(Error("Unable to load Botguard from JS")))};
function Gf(a,b,c){try{a.f=new window.botguard.bg(b)}catch(d){le(d)}c&&c(b)}
Ff.prototype.dispose=function(){this.f=null};var Hf=window,U=Hf.ytcsi&&Hf.ytcsi.now?Hf.ytcsi.now:Hf.performance&&Hf.performance.timing&&Hf.performance.now?function(){return Hf.performance.timing.navigationStart+Hf.performance.now()}:function(){return(new Date).getTime()};var If=new Ff,Jf=!1,Kf=0,Lf="";function Mf(a){Q("botguard_periodic_refresh")?Kf=U():Q("botguard_always_refresh")&&(Lf=a)}
function Nf(a){if(a){if(If.g)return!1;if(Q("botguard_periodic_refresh"))return 72E5<U()-Kf;if(Q("botguard_always_refresh"))return Lf!=a}else return!1;return!Jf}
function Of(){return!!If.f}
function Pf(a){a=void 0===a?{}:a;a=void 0===a?{}:a;return If.f?If.f.invoke(void 0,void 0,a):null}
;var Qf=0;w("ytDomDomGetNextId",y("ytDomDomGetNextId")||function(){return++Qf},void 0);var Rf={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
Sf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Va=y("ytEventsEventsListeners")||{};w("ytEventsEventsListeners",Va,void 0);var Uf=y("ytEventsEventsCounter")||{count:0};w("ytEventsEventsCounter",Uf,void 0);
...
var Wf=Ra(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function V(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Vf(a,b,c,d);if(e)return e;e=++Uf.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new Sf(h);if(!fc(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new Sf(h);
h.currentTarget=a;return c.call(a,h)};
g=ke(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Wf()||"boolean"===typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);Va[e]=[a,b,c,g,d];return e}
function Xf(a){a&&("string"==typeof a&&(a=[a]),F(a,function(b){if(b in Va){var c=Va[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Wf()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete Va[b]}}))}
;var Yf=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function Zf(a){this.w=a;this.f=null;this.j=0;this.o=null;this.l=0;this.h=[];for(a=0;4>a;a++)this.h.push(0);this.i=0;this.G=V(window,"mousemove",A(this.H,this));a=A(this.B,this);Aa(a)&&(a=ke(a));this.K=window.setInterval(a,25)}
C(Zf,K);Zf.prototype.H=function(a){void 0===a.f&&Tf(a);var b=a.f;void 0===a.g&&Tf(a);this.f=new Xb(b,a.g)};
...
function ag(a){var b=void 0===a?{}:a;a=void 0===b.Aa?!0:b.Aa;b=void 0===b.Ma?!1:b.Ma;if(null==y("_lact",window)){var c=parseInt(O("LACT"),10);c=isFinite(c)?B()-Math.max(c,0):-1;w("_lact",c,window);w("_fact",c,window);-1==c&&bg();V(document,"keydown",bg);V(document,"keyup",bg);V(document,"mousedown",bg);V(document,"mouseup",bg);a&&(b?V(window,"touchmove",function(){cg("touchmove",200)},{passive:!0}):(V(window,"resize",function(){cg("resize",200)}),V(window,"scroll",function(){cg("scroll",200)})));
...
function bg(){null==y("_lact",window)&&ag();var a=B();w("_lact",a,window);-1==y("_fact",window)&&w("_fact",a,window);(a=y("ytglobal.ytUtilActivityCallback_"))&&a()}
function dg(){var a=y("_lact",window);return null==a?-1:Math.max(B()-a,0)}
;var eg=Math.pow(2,16)-1,fg=null,gg=0,hg={log_event:"events",log_interaction:"interactions"},ig=Object.create(null);ig.log_event="GENERIC_EVENT_LOGGING";ig.log_interaction="INTERACTION_LOGGING";var jg=new Set(["log_event"]),kg={},lg=0,mg=0,ng=0,W=y("ytLoggingTransportLogPayloadsQueue_")||{};w("ytLoggingTransportLogPayloadsQueue_",W,void 0);var og=y("ytLoggingTransportTokensToCttTargetIds_")||{};w("ytLoggingTransportTokensToCttTargetIds_",og,void 0);var pg=y("ytLoggingTransportDispatchedStats_")||{};
w("ytLoggingTransportDispatchedStats_",pg,void 0);w("ytytLoggingTransportCapturedTime_",y("ytLoggingTransportCapturedTime_")||{},void 0);function qg(){S(lg);S(mg);mg=0;if(!Wa(W)){for(var a in W){var b=kg[a];b&&(rg(a,b),delete W[a])}Wa(W)||sg()}}
function sg(){Q("web_gel_timeout_cap")&&!mg&&(mg=R(qg,6E4));S(lg);lg=R(qg,O("LOGGING_BATCH_TIMEOUT",ve("web_gel_debounce_ms",1E4)))}
function tg(a,b){b=void 0===b?"":b;W[a]=W[a]||{};W[a][b]=W[a][b]||[];return W[a][b]}
function rg(a,b){var c=hg[a],d=pg[a]||{};pg[a]=d;var e=Math.round(U());for(p in W[a]){var f=$a,g=b.f;g={client:{hl:g.Ea,gl:g.Da,clientName:g.Ca,clientVersion:g.innertubeContextClientVersion,configInfo:g.Ba}};var h=window.devicePixelRatio;h&&1!=h&&(g.client.screenDensityFloat=String(h));h=O("EXPERIMENTS_TOKEN","");""!==h&&(g.client.experimentsToken=h);var k=h=void 0,l=[],n=O("EXPERIMENTS_FORCED_FLAGS",{});for(k in n)l.push({key:k,value:String(n[k])});k=O("EXPERIMENT_FLAGS",{});for(h in k)h.startsWith("force_")&&
void 0===n[h]&&l.push({key:h,value:String(k[h])});h=l;0<h.length&&(g.request={internalExperimentFlags:h});O("DELEGATED_SESSION_ID")&&!Q("pageid_as_header_web")&&(g.user={onBehalfOfUser:O("DELEGATED_SESSION_ID")});f=f({context:g});f[c]=tg(a,p);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=og[p])a:{l=p;if(g.videoId)h="VIDEO";else if(g.playlistId)h="PLAYLIST";else break a;f.credentialTransferTokenTargetId=g;f.context=f.context||{};f.context.user=f.context.user||
{};f.context.user.credentialTransferTokens=[{token:l,scope:h}]}delete og[p];f.requestTimeMs=e;if(g=de("EVENT_ID"))h=(O("BATCH_CLIENT_COUNTER",void 0)||0)+1,h>eg&&(h=1),N("BATCH_CLIENT_COUNTER",h),g={serializedEventId:g,clientCounter:h},f.serializedClientEventId=g,fg&&gg&&Q("log_gel_rtt_web")&&(f.previousBatchInfo={serializedClientEventId:fg,roundtripMs:gg}),fg=g,gg=0;ug(b,a,f,{retry:jg.has(a),onSuccess:A(vg,this,U())})}if(d.previousDispatchMs){c=e-d.previousDispatchMs;var p=d.diffCount||0;d.averageTimeBetweenDispatchesMs=
p?(d.averageTimeBetweenDispatchesMs*p+c)/(p+1):c;d.diffCount=p+1}d.previousDispatchMs=e}
function vg(a){gg=Math.round(U()-a)}
;var wg=y("ytLoggingGelSequenceIdObj_")||{};w("ytLoggingGelSequenceIdObj_",wg,void 0);
function xg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||U());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:dg())};Q("log_sequence_info_on_gel_web")&&d.P&&(a=e.context,b=d.P,wg[b]=b in wg?wg[b]+1:0,a.sequence={index:wg[b],groupKey:b},d.ob&&delete wg[d.P]);(d=d.ca)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),og[d.token]=a,d=tg("log_event",d.token)):d=tg("log_event");d.push(e);c&&(kg.log_event=new c);c=ve("web_logging_max_batch")||
100;e=U();d.length>=c?qg():10<=e-ng&&(sg(),ng=e)}
...
Pa(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){P(p)}},Gg[b.toString()]?y("yt.scheduler.instance")?yf(g):R(g,0):g())});
...
c=q(c);for(var e=c.next();!e.done;e=c.next())e=zg(e.value),(Wa(e)||!e.trackingParams&&!e.veType)&&Xe(Error("Child VE logged with no data"),"WARNING");c={ca:void 0,P:a};"UNDEFINED_CSN"==a?Tg("visualElementAttached",b,c):xg("visualElementAttached",b,d,c)}
...
;function Xg(){var a=new Td;(a=a.isAvailable()?new Zd(a,"yt.innertube"):null)||(a=new Ud("yt.innertube"),a=a.isAvailable()?a:null);this.f=a?new Pd(a):null;this.g=document.domain||window.location.hostname}
Xg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,B()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(ld(b))}catch(f){return}else e=escape(b);Wg(a,e,c,this.g)};
...
function ah(a){var b=Yg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=Vg(Ug(!1));Ya(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),ug(a,d.method,e,{}));delete b[c]}}Yg.set("requests",b,86400,!0)}}
;function Sg(a){var b=this;this.f=a||{innertubeApiKey:de("INNERTUBE_API_KEY"),innertubeApiVersion:de("INNERTUBE_API_VERSION"),Ba:O("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Ca:O("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:de("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ea:de("INNERTUBE_CONTEXT_HL"),Da:de("INNERTUBE_CONTEXT_GL"),Fa:de("INNERTUBE_HOST_OVERRIDE")||"",Ga:!!O("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};zf(function(){ah(b)},0,5E3)}
...
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Fa;g&&(f=g);g=a.f.Ga||!1;var h=Ug(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=oe(""+f+("/youtubei/"+a.f.innertubeApiVersion+"/"+b),{alt:"json",key:a.f.innertubeApiKey}),l;if(d.retry&&Q("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=Zg(b,c,h,g))){var n=e.onSuccess,p=e.ma;e.onSuccess=function(x,u){$g(l);n(x,u)};
c.ma=function(x,u){$g(l);p(x,u)}}try{Q("use_fetch_for_op_xhr")?Fe(k,e):(e.method="POST",e.C||(e.C={}),Ie(k,e))}catch(x){if("InvalidAccessError"==x)l&&($g(l),l=0),P(Error("An extension is blocking network request."),"WARNING");
else throw x;}l&&zf(function(){ah(a)},0,5E3)}
;var bh=B().toString();
...
w("yt_logging_screen.getRootVeType",gh,void 0);function hh(){var a=gh(0),b;a?b=new yg({veType:a,youtubeData:void 0}):b=null;return b}
...
w("yt_logging_screen.getCurrentCsn",ih,void 0);function jh(a,b,c){c=void 0===c?0:c;if(a!==O(eh(c))||b!==O(fh(c)))N(eh(c),a),N(fh(c),b),0==c&&(b=function(){setTimeout(function(){a&&xg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:dh,clientScreenNonce:a},Sg)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
w("yt_logging_screen.setCurrentScreen",jh,void 0);function kh(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=O("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=O("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=I(J(3,window.location.href));g&&f.push(g);g=I(J(3,d));if(0<=Ia(f,g)||!g&&0==d.lastIndexOf("/",0))if(Q("autoescape_tempdata_url")&&(f=document.createElement("a"),Ib(f,d),d=f.href),d){g=d.match(ic);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
b.ved)&&(b=Object.assign({csn:ih()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Lb(d).toString(36),e=e?kc(e):"",Wg(b,e,k||5))}else k=b,e="ST-"+Lb(d).toString(36),k=k?kc(k):"",Wg(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var n=void 0===n?"":n;var p=void 0===p?window:p;c=p.location;a=lc(a,l)+n;a=a instanceof G?a:yb(a);c.href=wb(a)}return!0}
;function lh(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||Za(b);this.assets=a.assets||{};this.attrs=a.attrs||Za(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
lh.prototype.clone=function(){var a=new lh,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==ya(c)?a[b]=Za(c):a[b]=c}return a};function mh(){K.call(this);this.f=[]}
...
function ph(a){var b=qh(a),c=document.getElementById(b),d=c&&bf(c,"loaded");d||c&&!d||(c=rh(a,b,function(){bf(c,"loaded")||($e(c),lf(b),R(Ga(mf,b),0))}))}
...
m.loadNewVideoConfig=function(a){if(!this.g){this.T&&(S(this.T),this.T=0);a instanceof lh||(a=new lh(a));this.ba=a;this.f=a.clone();uh(this);this.W||(this.W=wh(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.l.style.width=tc(Number(a)||a);if(a=this.f.attrs.height)this.l.style.height=tc(Number(a)||a);vh(this);this.w&&xh(this)}};
...
function yh(a){var b=!0,c=zh(a);c&&a.f&&(a=Ah(a),b=bf(c,"version")==a);return b&&!!y("yt.player.Application.create")}
...
a.K=!0;b?a.B():(qf(Ah(a),a.B),oh(a.o?a.o.cssUrl:a.f.assets.css),Dh(a)&&!c&&w("yt.player.Application.create",null,void 0))}}}
function zh(a){var b=Zb(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
...
function Fh(a,b,c){var d=b[c];return function(){try{return a.aa=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.aa=e,le(e))}}}
...
m.Z=function(a,b){var c=this,d=wh(this,b);if(d){if(!(0<=Ia(this.sa,a)||this.i[a])){var e=Gh(this,a);this.G&&this.G(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.w&&R(function(){d(c.api)},0)}};
m.Oa=function(a,b){if(!this.g){var c=wh(this,b);c&&Jd(this.H,a,c)}};
...
Xa(a.S,String(e))};
return c}
m.ua=function(a){lf("a11y-announce",a)};
...
m.cancel=function(){this.B&&wf(Ah(this),this.B);S(this.ja);this.K=!1};
...
;var Kh=window,X=Kh.performance||Kh.mozPerformance||Kh.msPerformance||Kh.webkitPerformance||{};function Lh(a,b){Bg.call(this,1,arguments)}
r(Lh,Bg);function Mh(a,b){Bg.call(this,1,arguments)}
r(Mh,Bg);var Nh=new Cg("aft-recorded",Lh),Oh=new Cg("timing-sent",Mh);var Ph=!1;function Qh(a,b){if(Q("debug_csi_data")){var c=y("yt.timing.csiData");c||(c=[],w("yt.timing.csiData",c,void 0));c.push({page:location.href,time:new Date,args:a})}c="";for(var d in a)a.hasOwnProperty(d)&&(c+="&"+d+"="+a[d]);d="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var e=void 0===e?"":e;Te(d,e)||Qe(d,void 0,void 0,void 0,e)}else Qe(d);Ha("yt.timing.pingSent_",!0)}
...
function Vh(a){var b;(b=y("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ha("ytcsi."+(a||"")+"data_",b));return b}
...
function Xh(){var a=Sh(""),b=Rh();b&&!Ph&&(Hg(Nh,new Lh(Math.round(b-a._start),void 0)),Ph=!0)}
...
c=q(c);for(d=c.next();!d.done;d=c.next())$h(a,d.value);return a}
...
function bi(a,b){for(var c=q(b),d=c.next();!d.done;d=c.next())d=d.value,Zh(d)?a.push($h({},d)):ai(d)?a.push(bi([],d)):a.push(d);return a}
...
;function ei(a,b,c){c=void 0===c?{}:c;var d=Sg;O("ytLoggingEventsDefaultDisabled",!1)&&Sg==Sg&&(d=null);xg(a,b,d,c)}
;var fi=y("ytLoggingLatencyUsageStats_")||{};w("ytLoggingLatencyUsageStats_",fi,void 0);var gi=0;function hi(a){fi[a]=fi[a]||{count:0};var b=fi[a];b.count++;b.time=U();gi||(gi=zf(ii,0,5E3));if(5<b.count){if(6==b.count&&1>1E5*Math.random()){b=0==a.indexOf("info")?"WARNING":"ERROR";var c=Error("CSI data exceeded logging limit with key");c.params=a;Xe(c,b)}return!0}return!1}
function ii(){var a=U(),b;for(b in fi)6E4<a-fi[b].time&&delete fi[b];gi=0}
...
;function qi(){Uh().yt_lt="hot_bg";if(oi()){var a="hot_bg";var b=pi();if(b.gelInfos)b.gelInfos.info_yt_lt=!0;else{var c={};b.gelInfos=(c.info_yt_lt=!0,c)}if("yt_lt"in ji){b=ji.yt_lt;0<=Ia(ki,b)&&(a=!!a);"yt_lt"in mi&&"string"===typeof a&&(a=mi.yt_lt+a.toUpperCase());b=b.split(".");for(var d=c={},e=0;e<b.length-1;e++){var f=b[e];d[f]={};d=d[f]}d[b[b.length-1]]=a;a=Yh({},c)}else 0<=Ia(ni,"yt_lt")||(a=new Ue("Unknown label logged with GEL CSI"),a.params={label:"yt_lt"},le(a)),a=void 0;a&&oi()&&(b=di(),
Yh(b.info,a),b=pi(),"gelInfos"in b||(b.gelInfos={}),Yh(b.gelInfos,a),b=Wh(),c=Object.keys(a).join(""),hi("info_"+c+"_"+b)||(a.clientActionNonce=b,ei("latencyActionInfo",a)))}else di().info.yt_lt="hot_bg"}
;var ri={vc:!0};function si(){if(!oi()){var a=Sh(void 0),b=Uh(),c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&z(a[f])){var d=f.slice(1);if(d in ri){var e=La(a[f],function(l){return Math.round(l-c)});
...
k.charAt(0)&&(g=Math.round(a[k]-c),h[k]=g,e.push(k+"."+g));f.rt=e.join(",");(a=y("ytdebug.logTiming"))&&a(f,h);Qh(f,!!b.ap);Hg(Oh,new Mh(h.aft+(d||0),void 0))}}
A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||wa,X);function ti(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
function vi(a,b,c){if(Ba(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function wi(a,b,c,d){if(Ba(a)&&!z(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function xi(a){a=void 0===a?!1:a;K.call(this);this.f=new M(a);Wc(this,Ga(Xc,this.f))}
...
r(yi,xi);function zi(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(ld(a),d.i))}}
...
m.m=function(){var a=this.f;a.g||Jd(a.f,"command",this.qa,this);this.f=null;for(var b in this.h)Bi(this,b);K.prototype.m.call(this)};function Ei(a,b){Ai.call(this,b);this.i=a;this.start()}
...
this))}
r(Ji,Gi);m=Ji.prototype;m.la=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&ti(a)){var d=b;if(Ba(d[0])&&!z(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=vi.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=ui.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=wi.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);ti(a)&&Ii(this,this.fa())}};
...
m.dispose=function(){Gi.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Ki(a,b,c){K.call(this);this.f=a;this.i=c;this.j=V(window,"message",A(this.l,this));this.h=new yi(this,a,b);Wc(this,Ga(Xc,this.h))}
...
Ki.prototype.m=function(){Xf(this.j);this.f=null;K.prototype.m.call(this)};function Li(){var a=Za(Mi),b;return yd(new L(function(c,d){a.onSuccess=function(e){ye(e)?c(e):d(new Ni("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
Oi.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),rd(a)?a:Pi(a)):2===this.g&&b?(a=b.call(c,this.f),rd(a)?a:Qi(a)):this};
...
;function Ri(a){D.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Si;this.isTimeout=a instanceof Ni&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof zd}
r(Ri,D);Ri.prototype.name="BiscottiError";function Si(){D.call(this,"Biscotti ID is missing from server")}
r(Si,D);Si.prototype.name="BiscottiMissingError";var Mi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Ti=null;function ge(){if("1"===Ta(ee(),"args","privembed"))return wd(Error("Biscotti ID is not available in private embed mode"));Ti||(Ti=yd(Li().then(Ui),function(a){return Vi(2,a)}));
return Ti}
function Ui(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Si;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new Si;a=a.id;he(a);Ti=Pi(a);Wi(18E5,2);return a}
function Vi(a,b){var c=new Ri(b);he("");Ti=Qi(c);0<a&&Wi(12E4,a-1);throw c;}
function Wi(a,b){R(function(){yd(Li().then(Ui,function(c){return Vi(b,c)}),wa)},a)}
function Xi(){try{var a=y("yt.ads.biscotti.getId_");return a?a():ge()}catch(b){return wd(b)}}
;function Yi(a){if("1"!==Ta(ee(),"args","privembed")){a&&fe();try{Xi().then(function(){},function(){}),R(Yi,18E5)}catch(b){P(b)}}}
;var Z=y("ytglobal.prefsUserPrefsPrefs_")||{};w("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Zi(){this.f=O("ALT_PREF_COOKIE_NAME","PREF");var a=Vb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
xa(Zi);var cj=null,dj=null,ej=null,fj={};function gj(a){var b=a.id;a=a.ve_type;var c=Ag++;a=new yg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});fj[b]=a;b=ih();c=hh();b&&c&&Rg(b,c,[a])}
function hj(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(jh(b,a),a=hh()))for(var c in fj){var d=fj[c];d&&Rg(b,a,[d])}}
function ij(a){fj[a.id]=new yg({trackingParams:a.tracking_params})}
function jj(a){var b=ih(),c=fj[a.id];if(b&&c){a=Sg;c={csn:b,ve:zg(c),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var d={ca:void 0,P:b};"UNDEFINED_CSN"==b?Tg("visualElementGestured",c,d):xg("visualElementGestured",c,a,d)}}
function kj(a){a=a.ids;var b=ih();if(b)for(var c=0;c<a.length;c++){var d=fj[a[c]];if(d){var e=Sg;d={csn:b,ve:zg(d),eventType:1};var f={ca:void 0,P:b};"UNDEFINED_CSN"==b?Tg("visualElementShown",d,f):xg("visualElementShown",d,e,f)}}}
;w("yt.setConfig",N,void 0);w("yt.config.set",N,void 0);w("yt.setMsg",Ze,void 0);w("yt.msgs.set",Ze,void 0);w("yt.logging.errors.log",Xe,void 0);
w("writeEmbed",function(){var a=O("PLAYER_CONFIG",void 0);Yi(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=O("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);O("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";b="string"===typeof b?Zb(b):b;var d=Ih+"_"+(b[Ca]||(b[Ca]=++Da)),e=Hh[d];e&&(void 0===f||f)?e.loadNewVideoConfig(a):(e=new sh(b,d,a,void 0),Hh[d]=e,lf("player-added",e.api),Wc(e,Ga(Jh,e)));a=e.api;
cj=a;a.addEventListener("onScreenChanged",hj);a.addEventListener("onLogClientVeCreated",gj);a.addEventListener("onLogServerVeCreated",ij);a.addEventListener("onLogVeClicked",jj);a.addEventListener("onLogVesShown",kj);var f=O("POST_MESSAGE_ID","player");O("ENABLE_JS_API")?ej=new Ji(a):O("ENABLE_POST_API")&&"string"===typeof f&&"string"===typeof c&&(dj=new Ki(window.parent,f,c),ej=new Ei(a,dj.h));c=de("BG_P");Nf(c)&&(O("BG_I")||O("BG_IU"))&&(Jf=!0,If.initialize(O("BG_I",null),O("BG_IU",null),c,Mf,void 0));
Df()},void 0);
w("yt.www.watch.ads.restrictioncookie.spr",function(a){Qe(a+"mac_204?action_fcts=1");return!0},void 0);
var lj=ke(function(){var a=Sh(void 0),b;(b=!Q("use_first_tick"))||(b=!("ol"in Sh(void 0)));if(b&&(b="ol",X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b)),b=U(),a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b)),a.ol=b,a=pi(),a.gelTicks&&(a.gelTicks.tick_ol=!0),U(),oi()?(di().tick.ol=void 0,a=Wh(),hi("tick_ol_"+a)||ei("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),Xh(),a=!0):a=!1,!a)){if(!y("yt.timing.pingSent_")&&(b=O("TIMING_ACTION",void 0),a=Sh(void 0),y("ytglobal.timingready_")&&
b&&a._start&&Rh())){Xh();b=!0;var c=O("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&si()}di().tick.ol=void 0}a=Zi.getInstance();c=!!((bj("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&ad(document.body,"exp-invert-logo")&&(b&&!ad(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):ad(d,"inverted-hdpi")||(e=Zc(d),$c(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi")))):!b&&ad(document.body,
"inverted-hdpi")&&bd());c!=b&&(c="f"+(Math.floor(119/31)+1),d=bj(c)||0,d=b?d|67108864:d&-67108865,0==d?delete Z[c]:(b=d.toString(16),Z[c]=b.toString()),a.save())}),mj=ke(function(){var a=cj;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();O("PL_ATT")&&If.dispose();a=0;for(var b=Bf.length;a<b;a++){var c=Bf[a];if(!isNaN(c)){var d=y("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}Bf.length=0;vf("//static.doubleclick.net/instream/ad_status.js");Cf=!1;N("DCLKSTAT",0);Yc(ej,dj);if(a=cj)a.removeEventListener("onScreenChanged",hj),a.removeEventListener("onLogClientVeCreated",gj),a.removeEventListener("onLogServerVeCreated",ij),a.removeEventListener("onLogVeClicked",jj),a.removeEventListener("onLogVesShown",
kj),a.destroy();fj={}});
window.addEventListener?(window.addEventListener("load",lj),window.addEventListener("unload",mj)):window.attachEvent&&(window.attachEvent("onload",lj),window.attachEvent("onunload",mj));Ha("yt.abuse.player.botguardInitialized",y("yt.abuse.player.botguardInitialized")||Of);Ha("yt.abuse.player.invokeBotguard",y("yt.abuse.player.invokeBotguard")||Pf);Ha("yt.abuse.dclkstatus.checkDclkStatus",y("yt.abuse.dclkstatus.checkDclkStatus")||Ef);
Ha("yt.player.exports.navigate",y("yt.player.exports.navigate")||kh);Ha("yt.util.activity.init",y("yt.util.activity.init")||ag);Ha("yt.util.activity.getTimeSinceActive",y("yt.util.activity.getTimeSinceActive")||dg);Ha("yt.util.activity.setTimestamp",y("yt.util.activity.setTimestamp")||bg);}).call(this);
